    ...
    return (
      <Drawer.Root open={isOpen} onOpenChange={onClose}>
        <Drawer.Portal>
          ...
          <Drawer.Content className="bg-white flex flex-col rounded-t-[24px] h-[35vh] mt-24 fixed bottom-0 left-0 right-0 z-50 outline-none">
            <div className="p-4 bg-white rounded-t-[24px] flex-1">
              ...
              <div className="flex flex-col items-center text-center gap-3">
                ...
                <Drawer.Title className="font-bold text-xl text-slate-900">{title}</Drawer.Title>
