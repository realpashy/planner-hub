    ...
    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
      <Card className="rounded-[1.7rem] border-border/70 bg-card/95 shadow-sm">
        <CardContent className="space-y-4 p-4 text-right">
          ...
          {!quota.aiEnabled ? (
            <div className="flex items-center justify-end gap-2 rounded-2xl border border-amber-500/20 bg-amber-500/10 px-3 py-2 text-xs text-amber-700 dark:text-amber-300">
